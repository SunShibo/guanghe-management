        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">新增产品优势</h4>
                </div>
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="margin-top: 300px;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="">修改产品优势</h4>
                </div>
                <div class="modal-body" style="margin-left:10px;">
...
<script>
                ...
                if(data.success == false){
                    ...
                    for(var i=0;i<data.data.data.length;i++){
                        html += '<tr>'+
                                    ...
                                    '<td>'+
                                        '<button type="button" data-toggle="modal" data-target="#updateModal" class="btn btn-info" onclick="updateById(' + "'" + data.data.data[i].id + "',"+ "'" + data.data.data[i].name + "'," + "'" + data.data.data[i].synopsis + "'" + ')">编辑</button>'+
    ...
    var updateId;
    function updateById(id,name,synopsis){
        $("#name1").val('');
        $("#synopsis1").val('');
