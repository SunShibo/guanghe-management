...
<div class="index clear">
  ...
  <div class="indexRight1">
    <div class="title">广和商学院 > 新闻动态添加</div>
    <div class="tablebox2">
...
<script>
  function addprivateConsultant(){
    ...
    $.ajax({
      type : "post",
      url : "/PolicyInterpreTation/add",
      data : {"title":title,"englishTitle":englishTitle,"content":messageContent,"source":source,"synopsis":synopsis,},
      dataType : "json",
      async : false,
