...
<div class="indexRight1">
  <div class="title">广和商学院 > 专家讲堂列表</div>
...
<script>
  ...
  function getdata(cur,size){
    ...
    $.getJSON("/ExpertIectureHall/list?pageNo="+cur+"&pageSize="+size+"&title="+title, function (rs) {
    ...
    $.ajax({
      ...
      success : function (data){
        if(data.success == false){
          ...
          alert("删除成功！");
          window.location.href="/ExpertIectureHall/page";
        }
      }
    });
  }
  ...
  function add(){
    window.location.href = "/ExpertIectureHall/toAdd";
  }

  function toUpdatePage(id){
    window.location.href = "/ExpertIectureHall/findOne?id="+id;
  }
