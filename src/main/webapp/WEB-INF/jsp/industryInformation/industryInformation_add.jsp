...
<div class="index clear">
  ...
  <div class="indexRight1">
    <div class="title">行业动态 > 行业动态添加</div>
    <div class="tablebox2">
...
<script>
  function addprivateConsultant(){
    ...
    $.ajax({
      type : "post",
      url : "/industryInformation/add",
      data : {"title":title,"englishTitle":englishTitle,"content":messageContent,"source":source,"synopsis":synopsis,"imgUrl":imageUrl},
      dataType : "json",
      async : false,
