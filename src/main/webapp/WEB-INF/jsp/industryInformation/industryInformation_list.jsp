...
<body>
    ...
    <div class="indexRight1">
        <div class="title">行业动态 > 行业动态列表</div>
...
<script>
    ...
    function getdata(cur,size){
        ...
        $.getJSON("/industryInformation/list?pageNo="+cur+"&pageSize="+size+"&title="+title, function (rs) {
    ...
    function deletePrivateInvestment(id){
        $.ajax({
            type : "post",
            url : "/industryInformation/delete",
            data : {"newsId":id},
            dataType : "json",
            async : false,
    ...
    function add(){
        window.location.href = "/industryInformation/toAdd";
    }

    function toUpdatePage(id){
        window.location.href = "/industryInformation/findOne?id="+id;
    }
