...
<script>
  ...
  function getdata(cur,size){
    ...
    $.getJSON("/activites/list?pageNo="+cur+"&pageSize="+size+"&title="+title, function (rs) {
  ...
  function add(){
    window.location.href = "/activites/toAdd";
  }

  function toUpdatePage(id){
    window.location.href = "/activites/findOne?id="+id;
  }
